...
def extractFeats(argv):
    ...
    while i < len(ptosdesenhada) and i < len(ptosoriginal):
        ...
        print(str(dif_rad) + " = " + str(radiusrigin[i].radius) + " - " + str(radiusangle[i].radius))
        ra.radius = abs(dif_rad)
        difradial.append(ra)
        # print(ra.radius, ra.angle)
    ...
    print("\n\n\n")
    for i in range(0, len(difradial)):
        ra1 = difradial[i]
        print(ra1.radius, ra1.angle)
    ...
    print("min_p:", min_p)
    print("difradial:", difradial)

    i = 0
    while i < len(ptosdesenhada) and i < len(ptosoriginal):
        # print(str(RMS) + " += " + str(difradial[i].radius) + " * " + str(difradial[i].radius))
