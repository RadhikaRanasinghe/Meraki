...
{
    double x,y,deltax,deltay,erro=0,q=0,quant;
    deltax=xf-xi;
    deltay=yf-yi;
    Vertices vert;
...
//    waitKey(0);
    ...
    cvtColor(img1, img1_, COLOR_BGR2RGB);
...
//    ofstream MyFile(R"(C:\Users\ASUS\CLionProjects\DetectTest\RMS.txt)");
//
//    // Write to the file
//    MyFile << class_img << " 1:" << RMS << " 2:" << std << " 3:" << maxRMS << " 4:" << minRMS << " 5:" << mean_tremor << " 6:" << max_tremor << " 7:" << min_tremor << " 8:" << std_tremor << "9:" << (double)count_cross/(double)count << "\n";
//
//    // Close the file
//    MyFile.close();
