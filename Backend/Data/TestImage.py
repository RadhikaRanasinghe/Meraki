class TestImage:
    """
    This class takes values of the features of the image taken for the test.
    ...
    def __str__(self) -> str:
        return "TestImage{rms=" + str(self.__rms) + \
               ", max_between_st_ht=" + str(self.__max_between_st_ht) + \
               ", min_between_st_ht=" + str(self.__min_between_st_ht) + \
               ", std_deviation_st_ht=" + str(self.__std_deviation_st_ht) + \
               ", mrt=" + str(self.__mrt) + \
               ", max_ht=" + str(self.__max_ht) + \
               ", min_ht=" + str(self.__min_ht) + \
               ", __std_ht=" + str(self.__std_ht) + \
               ", __changes_from_negative_to_positive_between_st_ht=" + str(
