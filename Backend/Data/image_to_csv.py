                ...
                try:
                    ...
                    for index, row in data.iterrows():
                        if row[1] == name:
                            ...
                            rms.append(row['RMS'])
                            max_st_ht.append(row['MAX_BETWEEN_ET_HT'])
                            min_st_ht.append(row['MIN_BETWEEN_ET_HT'])
                            std_st_ht.append(row['STD_DEVIATION_ET_HT'])
                            mrt.append(row['MRT'])
                            max_ht.append(row['MAX_HT'])
                            min_ht.append(row['MIN_HT'])
                            std_ht.append(row['STD_HT'])
