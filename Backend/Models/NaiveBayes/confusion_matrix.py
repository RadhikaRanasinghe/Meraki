...
def confusion_matrix():
    """ This method outputs the normalized and non-normalized confusion matrix
    for the Naive Bayes classifier model. metrics and matplotlib is used to visually
    represent both matrices"""
